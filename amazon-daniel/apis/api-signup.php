...
if( strlen( $_POST['name'] ) > 20 ){ send_400('name max 20 characters'); }

// Validate last_name
if( ! isset( $_POST['last_name'] ) ){ send_400('last_name is required'); }
if( strlen( $_POST['last_name'] ) < 2 ){ send_400('last_name min 2 characters'); }
if( strlen( $_POST['last_name'] ) > 20 ){ send_400('last_name max 20 characters'); }
...
try{
  ...
  $q->bindVallue(":user_password", $_POST['password']);
  $q->execute();
